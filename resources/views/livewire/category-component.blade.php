                            ...
                            <div class="sort-by-product-area">
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $pageSize==12 ? 'active': ''}}" href="#" wire:click.prevent="chengePagesize(12)">12</a></li>
                                            <li><a class="{{ $pageSize==15 ? 'active': ''}}" href="#" wire:click.prevent="chengePagesize(15)">15</a></li>
                                            <li><a class="{{ $pageSize==25 ? 'active': ''}}" href="#" wire:click.prevent="chengePagesize(25)">25</a></li>
                                            <li><a class="{{ $pageSize==32 ? 'active': ''}}" href="#" wire:click.prevent="chengePagesize(32)">32</a></li>
                                        </ul>
                                    </div>
                                </div>
