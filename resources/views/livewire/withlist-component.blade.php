                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ isset($item->slug) ? route('product.details', ['slug' => $item->slug]) : '#' }}">
                                            <img class="default-img" src="{{ asset('assets/imgs/shop/product-')}}{{$item->id}}-1.jpg" alt="{{$item->name}}">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="product-action-1 show">
                                        ...
                                        <a aria-label="Remove From Wishlist" class="action-btn hover-up wishlisted" href="#" wire:click.prevent="removeFromWishlist({{$item->id}})"><i class="fi-rs-heart"></i></a>
